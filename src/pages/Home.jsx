...
const Home = () => {
  ...
  return (
    <div className="home">
      <Helmet>
        <title>
          ibendouma vous permet de vendre vos kamas au meilleur prix du marché.
          Des ventes fluides et sécurisées ont lieu chaque jour.Echangez vos
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Vendez vos kamas Dofus à de meilleurs prix.N'hesitez pas à vister notre site wew"
        />
      </Helmet>
      <Helmet>
        ...
        <meta
          name="description"
          content="Echangez vos kamas en toute sécurité sur ibendouma, nous vous enverrons des messages privés en jeu avec le code que vous avez choisi. "
        />
      </Helmet>
      <Helmet>
        ...
        <meta
          name="description"
          content="Vendez vos soldes au meilleur prix du marché sur ibendouma."
        />
      </Helmet>
        ...
        {language === "anglais" ? (
          ...
          <div className="dofus-desc">
            <p>
              ...
              l’argent? ibendouma est là pour vous acheter tous vos stocks de
