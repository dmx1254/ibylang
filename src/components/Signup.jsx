...
const Signup = () => {
  ...
  const handleDhsRib = (e) => {
    let dhsInter = e.target.value;
    let dhsRibToTrim = dhsInter.trim();
    setDhsRib(dhsRibToTrim);
  };
    ...
    if (!data) {
      ...
      try {
        axios({
          ...
          if (res.data.errors) {
            if (res.data.errors.email !== "Email incorrect") {
              ...
              {paymentSelected === "virement bancaire" && (
                <div className="container-secondform-single-bank-transfert">
                  ...
                  <div className="errors-signup">
                    NB:{" "}
                    {language === "anglais" && "RIB must contain 24 numbers"}
                    {language === "francais" &&
                      "Le RIB doit contenir 24 nombres"}
                    {language === "espagnol" &&
                      "La RIB debe contener 24 números"}
                  </div>
